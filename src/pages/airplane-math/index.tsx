        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            <div className="flex justify-between items-start p-6">
                <div className="flex flex-col gap-3 pointer-events-auto">
                    ...
                    {gameState === 'playing' && (
                        <Button size="icon" className="rounded-xl h-12 w-12 bg-amber-400 hover:bg-amber-500 text-slate-900 border-b-4 border-amber-700 active:border-b-0 active:translate-y-1" onClick={pauseGame}>
                ...
                <div className="pointer-events-auto">
                    <Button variant="destructive" className="rounded-xl h-12 px-4 border-b-4 border-red-800 active:border-b-0 active:translate-y-1" onClick={handleExit}>
